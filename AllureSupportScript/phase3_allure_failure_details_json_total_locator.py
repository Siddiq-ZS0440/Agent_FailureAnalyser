...
# XPath locator to capture total test count from Overview.
OVERVIEW_TOTAL_TEST_COUNT_XPATH = "//div[contains(@class,'summary-widget')]//div[@class='splash__title']"
...
def get_total_test_count_from_overview(page: Page) -> int:
    """Capture total test count from the Overview page using the summary-widget splash title XPath."""
