...
Usage:
    python phase2_failed_leaf_anchor_solution.py /path/to/Allure_Report.html
...
def get_report_url(html_file_path: str) -> str:
    ...
    if not html_path.exists():
        raise FileNotFoundError(
            ...
            "python phase2_failed_leaf_anchor_solution.py "
...
def process_failed_suite(page: Page, suite_node: Locator, suite_index: int) -> None:
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            for suite_index in range(suite_node_count):
                ...
                process_failed_suite(page, suite_node, suite_index)
