...
and count failed tests inside each failed Suite using XPath.

Usage:
    python phase2_from_user_latest_locator_only.py /path/to/Allure_Report.html
...
Notes:
    ...
    - XPath locators are used for Suites section detection, suite counting,
      failed suite detection, and failed test counting.
"""
...
def get_report_url(html_file_path: str) -> str:
    ...
    if not html_path.exists():
        raise FileNotFoundError(
            ...
            "python phase2_from_user_latest_locator_only.py "
